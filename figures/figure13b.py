...
from simopt.experiment_base import read_experiment_results, post_normalize, plot_progress_curves_it


m = 20 # Macro-replication
L = 200 # Post-replication

problem_name = "MAXCUTIT-1"
...
plot_progress_curves_it(experiments=[myexperiment[idx] for idx in range(n)], plot_type="mean", normalize=False, all_in_one=True, print_max_hw=False)
