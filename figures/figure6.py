...
from simopt.experiment_base_log import ProblemSolver, plot_area_scatterplots, post_normalize, plot_progress_curves, plot_solvability_cdfs, read_experiment_results, plot_solvability_profiles, plot_terminal_scatterplots, plot_terminal_progress
...
def main():
    ...
    for i in range(num_problems):
        ...
        for solver in solvers:
            solver_name = solver
            if solver == "NELDMDQ":
                solver_fixed_factors = {"alpha": 1., "gammap": 2., "betap": 0.5, "delta": 0.5}
            # Temporarily store experiments on the same problem for post-normalization.
